    ...
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-100 p-1 rounded-xl inline-flex shadow-inner">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-medium transition-all duration-200 ${
                activeTab === 'customer' 
                  ? 'bg-white text-pink-600 shadow-sm ring-1 ring-black/5 scale-105' 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Image Side */}
          <div className="order-2 lg:order-1 relative group lg:sticky lg:top-24">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {(activeTab === 'customer' ? FEATURES_CUSTOMER : FEATURES_OWNER).map((feature, idx) => (
                <div key={idx} className="flex flex-col gap-3 p-4 rounded-xl bg-gray-50 hover:bg-white hover:shadow-md transition-all border border-gray-100 group">
